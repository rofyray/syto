 ...
 */
export const validateContentRequest = (req, res, next) => {
    const errors = [];
 ...
 */
export const validateModuleRequest = (req, res, next) => {
    const errors = [];
 ...
 */
export const validateLearningPathRequest = (req, res, next) => {
    const errors = [];
 ...
 */
export const validateCulturalContextRequest = (req, res, next) => {
    const errors = [];
 ...
 */
export const validateAssessmentRequest = (req, res, next) => {
    const errors = [];
...
export const sanitizeInput = (req, _res, next) => {
    ...
    if (req.body.topic)
        req.body.topic = sanitizeString(req.body.topic);
    if (req.body.culturalContext)
        req.body.culturalContext = sanitizeString(req.body.culturalContext);
    if (req.body.moduleContext)
        req.body.moduleContext = sanitizeString(req.body.moduleContext);
    if (req.body.topicContext)
        req.body.topicContext = sanitizeString(req.body.topicContext);
    if (req.body.exerciseContext)
        req.body.exerciseContext = sanitizeString(req.body.exerciseContext);
    next();
};
